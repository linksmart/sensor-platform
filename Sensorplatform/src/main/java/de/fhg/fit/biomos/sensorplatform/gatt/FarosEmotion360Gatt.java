...
public class FarosEmotion360Gatt {
  ...
  // using bluez terminal commands hcitool for scanning, gatttool for
  // interaction
  // gatttool -I
  // connect EC:FE:7E:15:D5:EB
  ...
  // cmd: characteristics hnd1 hnd2
  // lists all characteristics in range hnd1 to hnd2

  // cmd: char-read-uuid uuid1
  // read value from uuid1
  ...
  // cmd: char-read-hnd hnd1
  // read value from handle hnd1
  ...
  public static final String HANDLE_PERIPHERAL_PREFERRED_CONNECTION_PARAMETERS = "0x008"; // 08
                                                                                          // 00
                                                                                          // 10
                                                                                          // 00
                                                                                          // 00
  ...
  public static final String HANDLE_BRSP_INFO = "0x000f"; // 03 00 02 11 00 13
                                                          // 00 15 00 16 00 18
                                                          // 00 1a 00 1b 00
  public static final String HANDLE_BRSP_MODE = "0x0011"; // 00
  public static final String HANDLE_BRSP_RX = "0x0013"; // write only!
  public static final String HANDLE_BRSP_TX = "0x0015"; // no read/ Data sent to
                                                        // Client PC/ANDROID
                                                        // from BLE (?????)

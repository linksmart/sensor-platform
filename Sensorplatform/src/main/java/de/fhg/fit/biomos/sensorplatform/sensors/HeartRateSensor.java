...
public abstract class HeartRateSensor extends Sensor {
  ...
  public HeartRateSensor(Properties properties, SensorName name, String bdAddress, AddressType addressType, JSONObject sensorConfiguration) {
   ...
   */
  protected boolean isSkinContactDetected(String rawHexValues) throws InvalidSensorDataException {
    if (isSkinContactDetectionSupported(rawHexValues)) {
      ...
      throw new InvalidSensorDataException("Skin contact detection is not supported.");
    }
  }
   ...
   */
  protected List<Integer> getRRintervalsWith8BitHeartRateData(String rawHexValues) throws InvalidSensorDataException {
   ...
   *           if the input string does not have the expected format
   */
  protected List<Integer> getRRintervalsWith16BitHeartRateData(String rawHexValues) throws InvalidSensorDataException {
   ...
   *           if the input string does not have the expected format
   */
  protected List<Integer> getRRintervals(int index, String rawHexValues) throws InvalidSensorDataException {
    ...
    try {
      ...
      throw new InvalidSensorDataException("Bad input data. Cannot read RR intervals.");
    }
    return rrIntervals;
  }
}

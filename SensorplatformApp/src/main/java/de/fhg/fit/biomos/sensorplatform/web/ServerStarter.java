...
/**
 * Initialise dependency injection (Guice) configuration and starts a webserver. The GUICE setup is quite heavy and takes several seconds to finish. The
 * webserver uses http basic authentication and a self-created certificate generated by linux keystore for https connections.
 *
 * @author Daniel Pyka
 *
 */
